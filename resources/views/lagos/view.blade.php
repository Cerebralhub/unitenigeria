		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">List of Delegates</h4>
					</div>
					<div class="pb-20">
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" href="{{url('/delegate-profile-single', $item->id)}}"><i class="dw dw-eye"></i> View</a>
												<a class="dropdown-item" href="{{url('/delegate-edit', $item->id)}}"><i class="dw dw-edit2"></i> Edit</a>
												<a class="dropdown-item" href="{{url('/delegate-delete', $item->id)}}"><i class="dw dw-delete-3"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>

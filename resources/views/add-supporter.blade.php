...
<img src="{{url('/images/pic7.jpg')}}" alt="register" width="100%">
              ...
              <div class="container">
                ...
                @if(Session::has('success'))
                  ...
                  <form action="/register_supporter" method="post">
                        ...
                        <div class="col-md-6" style="padding-right:30px;">
                          ...
                          <div class="form-group">
                              <label for="gender" style="justify-content: left;">Gender</label>
                                  <select name="gender" required="" style="width: 100%;  height:40px; background-color:white;">
                          ...
                          <div class="form-group">
                              ...
                              <select name="age" required="" style="width: 100%;  height:40px; background-color:white;">
                                  <option value="" selected="selected">- Select -</option>
                        ...
                        <div class="col-md-6" style="padding-left: 30px;">                      
                          ...
                          <div class="form-group">
                              ...
                              <label for="state" style="justify-content: left;">State of Origin</label>
                                <select name="state" required="" style="width: 100%; height:40px; background-color:white;">
                                <option value="" selected="selected">- Select -</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="state2" style="justify-content: left;">Voting State</label>
                                      <select name="state2" required="" style="width: 100%; height:40px; background-color:white;">
                                      <option value="" selected="selected">- Select -</option>
                                      <option value="Abia">Abia</option>
                                      <option value="Adamawa">Adamawa</option>
                                      <option value="Akwa Ibom">Akwa Ibom</option>
                                ...
                                <div class="form-group">
                                    <label>Ward</label>
                                    <input type="text" name="ward" class="form-control" placeholder="" required="">
                               
                                </div>

                                <div class="form-group">
                                    <label>Polling Unit</label>
                                    <input type="text" name="pu" class="form-control" placeholder="" required="">

...
<div class="header">
  ...
  <div class="card" style="padding-top: 100px;">
    ...
    <div class="card-header text-center font-weight-bold">
      <h2>Lagos House of Assembly</h2>
    </div>

    <div class="col-md-12 mt-1 mb-2"><br/><button type="button" id="addNewBook" class="btn btn-success">Add Lagos Assembly Member</button></div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="id" id="id">
              ...
              <div class="form-group">
                <label for="social" class="col-sm-2 control-label">Social</label>
                <div class="col-sm-12">

...
<div class="header">
  ...
  <div class="card" style="padding-top: 100px;">
    ...
    <div class="col-md-12 mt-1 mb-2"><br/><button type="button" id="addNewBook" class="btn btn-success">Add Delegate</button></div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="id" id="id">
              ...
              <div class="form-group">
                <label for="lga" class="col-sm-2 control-label"> Local Government</label>
                <div class="col-sm-12">
                  <input type="text" class="form-control" id="lga" name="lga" placeholder="" required="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <select id="category" class="form-control" name="category">
                    <option></option>
                    <option>Board of Trustees Members</option>
                    <option>Serving and former National legislators</option>
                    <option>Serving State legislators</option>
                    <option>LGA Party Chairman and Secretaries</option>
                    <option>3 Elected delegates from LGAs</option>
                    <option>State Working Committee</option>
                    <option>National Exco</option>
                </select>
                </div>
              </div>
